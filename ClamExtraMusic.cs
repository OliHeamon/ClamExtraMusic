...
namespace ClamExtraMusic
{
    public class ClamExtraMusic : Mod
    {
        public override void Load()
        {
            ...
            AddContent(new BossMusicSceneEffect("FieryFistsOfStone", NPCID.Golem));
            AddContent(new BossMusicSceneEffect("Gardenmetal", NPCID.Plantera));
            ...
            AddContent(new BossMusicSceneEffect("Omnipotence", NPCID.MoonLordCore));
